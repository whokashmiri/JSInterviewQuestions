...
// when you give a object as the key of another object it gets converted to a string. In this case, both b and c are objects, and when they are used as keys, they are both converted to the string "[object Object]". This means that both a[b] and a[c] refer to the same property, a["[object Object]"].

// Here's a step-by-step explanation:

// const a = {}; creates an empty object a.

// const b = {key: "b"}; creates an object b.

// const c = {key: "c"}; creates an object c.

// a[b] = 324; sets the property a["[object Object]"] to 324.

// a[c] = 43; sets the property a["[object Object]"] to 43, overwriting the previous value of 324.

// console.log(a[b]); logs the value of a["[object Object]"], which is now 43.
...
console.log(JSON.parse(objUser));
...
const { info: { name, address: { city, zip } } } = use;
console.log(use);
